...
colors<-c("red", "pink", "green", "yellow", "blue", "violet", "orange", "aquamarine1")

bar_positions<-barplot(scores,
        names.arg=subjects,
        col=colors,
...
text(x = bar_positions,
     y = scores,
     label = scores,
     pos = 3) # pos = 3 nghĩa là hiển thị phía trên cột
...
hist(exam_scores,
     breaks = 10,
     col = "aquamarine1",
     main = "Phân bố điểm thi của sinh viên",
     xlab = "Điểm",
     ylab = "Số sinh viên")
...
hist(exam_scores,
     breaks = 20,
     col = "aquamarine1",
     main = "Phân bố điểm thi (20 bins)",
     xlab = "Điểm",
     ylab = "Số sinh viên")

# Thêm lại đường trung bình
abline(v = mean_score, col = "red", lwd = 2)
...
boxplot(Petal.Length ~ Species,
        data = iris,
        col = c("pink", "aquamarine1", "skyblue"),
